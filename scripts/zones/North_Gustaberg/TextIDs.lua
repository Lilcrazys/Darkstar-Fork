...
-- Quests
SHINING_OBJECT_SLIPS_AWAY = 7413; -- The shining object slips through your fingers and is washed further down the stream.

-- Other Dialog
        NOTHING_HAPPENS = 292;  -- Nothing happens...
NOTHING_OUT_OF_ORDINARY = 6570; -- There is nothing out of the ordinary here.
  REACH_WATER_FROM_HERE = 7420; -- You can reach the water from here.
...
-- Voidwatch (NOTE: this is not a retail implementation!) These will need recheck/correction every time there is a client update.
   CRUOR_TOTAL = 7155; -- Obtained <Numeric Parameter 0> cruor. (Total: <Numeric Parameter 1>)<Prompt>
OBTAINED_BAYLD = 7174; -- You have obtained <Numeric Parameter 0> bayld!<Prompt>
