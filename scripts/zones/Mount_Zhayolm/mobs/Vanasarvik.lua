...
function onMobDeath(mob, killer)
    ...
    if (killer:hasKeyItem(AMBER_STRATUM_ABYSSITE)) then -- Vanasarvik Kill
        if (killer:getMaskBit(killer:getVar("AMBER_STRATUM"), 3) == false) then
           killer:setMaskBit(killer:getVar("AMBER_STRATUM"),"AMBER_STRATUM",3,true);
        end
