...
function onTrigger(player,npc)
    local STRATUM = player:hasKeyItem(WHITE_STRATUM_ABYSSITE);
    local mobID = 17179265;
    ...
    if (npc:getXPos(-245) and npc:getYPos(7.75) and npc:getZPos(245)) then
        correctNPC = true;
    end
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 6000 and option == 1) then
        ...
        SpawnMob(17179265, 300):updateClaim(player);
    end
end;