...
function onEventFinish(player,csid,option)
    ...
    -- Keyitems
    elseif (option == 65539) then -- Map of Abyssea - Empyreal_Paradox
        if (player:hasKeyItem(MAP_OF_ABYSSEA_Empyreal_Paradox) == false) then
            player:messageSpecial(KEYITEM_OBTAINED,MAP_OF_ABYSSEA_Empyreal_Paradox);
            player:addKeyItem(MAP_OF_ABYSSEA_Empyreal_Paradox);
