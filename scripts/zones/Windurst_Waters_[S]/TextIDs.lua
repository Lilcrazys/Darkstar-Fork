...
ITEM_CANNOT_BE_OBTAINED = 6379;  -- You cannot obtain the item <item> come back again after sorting your inventory
       ...
       KEYITEM_OBTAINED = 6385;  -- Obtained key item: <keyitem>
          HOMEPOINT_SET = 10817; -- Home point set!
 FISHING_MESSAGE_OFFSET = 7030;  -- You can't fish here


-- General Dialog
   YASSI_POSSI_DIALOG = 10829; -- Swifty-wifty and safey-wafey parcel delivery! Is there something you need to send?
MIKHE_ARYOHCHA_DIALOG = 12409; -- Do you like the headpiece? I made it from my firrrst victim. I wear it to let everrryone know what happens when they cross Mikhe Aryohcha!
    LUTETE_DIALOG = 12411; -- Mastering these Near Eastern magics can be quite taxing. If I had a choice, I'd rather be back in bed, relaxing...
