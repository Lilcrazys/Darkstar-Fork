...
function onMobDeath(mob, killer, ally)
    ...
    if (ally:hasKeyItem(HYACINTH_STRATUM_ABYSSITE)) then -- Fjalar Kill
        if (ally:getMaskBit(ally:getVar("HYACINTH_STRATUM"), 0) == false) then
           ally:setMaskBit(ally:getVar("HYACINTH_STRATUM"),"HYACINTH_STRATUM",0,true);
        end
