...
function onTrigger(player,npc)
    local STRATUM = player:hasKeyItem(WHITE_STRATUM_ABYSSITE_II);
    local mobID = 17584428;
    ...
    if (npc:getXPos(55) and npc:getYPos(-0.445) and npc:getZPos(260)) then
        correctNPC = true;
    end
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 6000 and option == 1) then
        ...
        SpawnMob(17584428, 300):updateClaim(player);
    end
end;