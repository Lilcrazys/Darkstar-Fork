...
function onMobDeath(mob, killer, ally)
    ...
    if (ally:hasKeyItem(AMBER_STRATUM_ABYSSITE)) then -- Brekekekex Kill
        if (ally:getMaskBit(ally:getVar("AMBER_STRATUM"), 1) == false) then
           ally:setMaskBit(ally:getVar("AMBER_STRATUM"),"AMBER_STRATUM",1,true);
        end
