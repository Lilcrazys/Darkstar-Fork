...
function onTrigger(player,npc)
    ...
    if (npc:getXPos(-406) and npc:getYPos(-8) and npc:getZPos(44)) then
        correctNPC = true;
    end
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 6000 and option == 1) then
        ...
        SpawnMob(16875780, 300):updateClaim(player);
        SpawnMob(16875781, 300):updateClaim(player);
        SpawnMob(16875782, 300):updateClaim(player);
    end
end;