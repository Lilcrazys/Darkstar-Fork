    ...
    if (csid == 895) then
        ...
        if (keyItem ~= nil and cost ~= nil) then
            if (player:hasKeyItem(keyItem)) then
                player:PrintToPlayer("Mimble-Pimble : You already posses that Phantom Gem. ", chatType.NS_SAY);
            else
                ...
                if (meritCount >= cost) then
                    ...
                    player:PrintToPlayer("Mimble-Pimble : You haven't enough. I can do nothing with that amount. ", chatType.NS_SAY);
                end
            end
        end
    end]]
