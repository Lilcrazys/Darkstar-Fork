...
function onTrade(player,npc,trade)
    ...
    if (Zilart_clear == false or Chains_clear == false) then
        ...
        elseif (trade:hasItemQty(2813,20) and trade:hasItemQty(15561,1) and trade:getItemCount() == 21) then    -- legs 2813
            itemID == 28090;
        elseif (trade:hasItemQty(2819,20) and trade:hasItemQty(15352,1) and trade:getItemCount() == 21) then    -- legs 2819
            itemID == 28223;
        ...
        elseif (trade:hasItemQty(2817,20) and trade:hasItemQty(15562,1) and trade:getItemCount() == 21) then    -- legs 2817
            itemID == 28091;
        elseif (trade:hasItemQty(2811,20) and trade:hasItemQty(15353,1) and trade:getItemCount() == 21) then    -- legs 2811
            itemID == 28224;
        ...
        elseif (trade:hasItemQty(2811,20) and trade:hasItemQty(15567,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28096;
        elseif (trade:hasItemQty(2822,20) and trade:hasItemQty(15358,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28229;
        ...
        elseif (trade:hasItemQty(2814,20) and trade:hasItemQty(15568,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28097;
        elseif (trade:hasItemQty(2813,20) and trade:hasItemQty(15359,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28230;
        ...
        elseif (trade:hasItemQty(2818,20) and trade:hasItemQty(15569,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28098;
        elseif (trade:hasItemQty(2817,20) and trade:hasItemQty(15360,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28231;
        ...
        elseif (trade:hasItemQty(2812,20) and trade:hasItemQty(15570,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28099;
        elseif (trade:hasItemQty(2815,20) and trade:hasItemQty(15361,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28232;
        ...
        elseif (trade:hasItemQty(2820,20) and trade:hasItemQty(15571,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28100;
        elseif (trade:hasItemQty(2821,20) and trade:hasItemQty(15362,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28233;
        ...
        elseif (trade:hasItemQty(2822,20) and trade:hasItemQty(15572,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28101;
        elseif (trade:hasItemQty(2816,20) and trade:hasItemQty(15363,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28234;
        ...
        elseif (trade:hasItemQty(2813,20) and trade:hasItemQty(15573,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28102;
        elseif (trade:hasItemQty(2819,20) and trade:hasItemQty(15364,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28235;
        ...
        elseif (trade:hasItemQty(2817,20) and trade:hasItemQty(15574,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28103;
        elseif (trade:hasItemQty(2811,20) and trade:hasItemQty(15365,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28236;
        ...
        elseif (trade:hasItemQty(2815,20) and trade:hasItemQty(15575,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28104;
        elseif (trade:hasItemQty(2814,20) and trade:hasItemQty(15366,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28237;
        ...
        elseif (trade:hasItemQty(2821,20) and trade:hasItemQty(16345,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28105;
        elseif (trade:hasItemQty(2818,20) and trade:hasItemQty(11381,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28238;
        ...
        elseif (trade:hasItemQty(2816,20) and trade:hasItemQty(16348,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28106;
        elseif (trade:hasItemQty(2812,20) and trade:hasItemQty(11384,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28239;
        ...
        elseif (trade:hasItemQty(2819,20) and trade:hasItemQty(16358,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28109;
        elseif (trade:hasItemQty(2820,20) and trade:hasItemQty(11394,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28242;
        ...
        elseif (trade:hasItemQty(2819,20) and trade:hasItemQty(16357,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28108;
        elseif (trade:hasItemQty(2820,20) and trade:hasItemQty(11393,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28241;
        ...
        elseif (trade:hasItemQty(2811,20) and trade:hasItemQty(16359,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28110;
        elseif (trade:hasItemQty(2822,20) and trade:hasItemQty(11395,1) and trade:getItemCount() == 21) then    -- legs
            itemID == 28243;
        end
