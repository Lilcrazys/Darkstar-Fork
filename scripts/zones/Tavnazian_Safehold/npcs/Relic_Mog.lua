...
function onTrade(player,npc,trade)
    ...
    if (Zilart_clear == false or Chains_clear == false) then
        ...
        -- WAR
        if  (trade:hasItemQty(2812,20) and trade:hasItemQty(10650,1) and trade:getItemCount() == 21) then    -- head 2812
            itemID == 26624;
        ...
        -- MNK
        elseif (trade:hasItemQty(2820,20) and trade:hasItemQty(10651,1) and trade:getItemCount() == 21) then    -- head 2820
            itemID == 26626;
        ...
        elseif (trade:hasItemQty(2822,20) and trade:hasItemQty(10652,1) and trade:getItemCount() == 21) then    -- head 2822
            itemID == 26628;
        elseif (trade:hasItemQty(2816,25) and trade:hasItemQty(10672,1) and trade:getItemCount() == 26) then    -- body 2816
            itemID == 26804;
        ...
        -- THF
        elseif (trade:hasItemQty(2817,20) and trade:hasItemQty(10655,1) and trade:getItemCount() == 21) then    -- head 2817
            itemID == 26634;
