...
function onMobDeath(mob, killer, ally)
    ...
    if (ally:hasKeyItem(WHITE_STRATUM_ABYSSITE_VI)) then -- Botulus Rex Kill
        if (ally:getMaskBit(ally:getVar("JEUNO_VW"), 4) == false) then
            ally:setMaskBit(ally:getVar("JEUNO_VW"),"JEUNO_VW",4,true);
        end
