...
function onTrigger(player,npc)
    ...
    if (npc:getXPos(318) and npc:getYPos(9) and npc:getZPos(-26)) then
        correctNPC = true;
    end
...
function onEventFinish(player,csid,option)
    ...
    if (csid == 6000 and option == 1) then
        ...
        SpawnMob(17404339, 300):updateClaim(player);
        SpawnMob(17404340, 300):updateClaim(player);
        SpawnMob(17404341, 300):updateClaim(player);
    end
end;