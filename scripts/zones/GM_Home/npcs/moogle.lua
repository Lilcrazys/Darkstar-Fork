...
----------------------------Karieyh-------------------------------------
        ...
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(27925,1) and trade:getItemCount() == 6) then     -- body
            PRIZE = 27863
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28065,1) and trade:getItemCount() == 6) then      --hands
            PRIZE = 28042
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28205,1) and trade:getItemCount() == 6) then      --legs
            PRIZE = 28182
    ...
    -------------------------Thurandaunts-------------------------------------
        ...
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(27924,1) and trade:getItemCount() == 6) then      --body
            PRIZE = 27896
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28064,1) and trade:getItemCount() == 6) then      --hands
            PRIZE = 28043
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28204,1) and trade:getItemCount() == 6) then      --legs
            PRIZE = 28183
    ...
    ----------------------------Orvail------------------------------------
        ...
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(27922,1) and trade:getItemCount() == 6) then       --body
            PRIZE = 27897
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28061,1) and trade:getItemCount() == 6) then       --hands
            PRIZE = 28044
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28203,1) and trade:getItemCount() == 6) then       --legs
            PRIZE = 28184
        elseif (trade:hasItemQty(3925, 10) and trade:hasItemQty(28342,1) and trade:getItemCount() == 6) then       --feet
            PRIZE = 28322
        end
