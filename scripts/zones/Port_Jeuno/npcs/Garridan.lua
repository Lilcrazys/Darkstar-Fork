...
function onTrade(player,npc,trade)
    ...
    elseif (month == 8 and day >= 3 and day <= 17) then -- Sunbreeze Festival ~ Aug 3 - Aug 17
        ...
        player:PrintToPlayer("I don't have special deals to show you right now. ", chatType.SAY, npc:getName());
    end
end;
...
function onTrigger(player,npc)
    ...
    elseif (month == 5 and day >= 12 and day <= 25) then -- Adventurer Appreciation Campaign (and Mog Bonanza) ~ May 12 - May 25
        ...
        player:PrintToPlayer("For a small deposit of a 1 gil trade, I can show you our fine selection of hand crafted statues. ", chatType.SAY, npc:getName());
    ...
    elseif (month == 8 and day >= 3 and day <= 17) then -- Sunbreeze Festival ~ Aug 3 - Aug 17
        ...
        player:PrintToPlayer("For a small deposit of a 1 gil trade, I can show you our fine selection of summer swim-wear. ", chatType.SAY, npc:getName());
    ...
    elseif ((month == 10 and day >= 17) or (month == 11 and day <= 2)) then --  Harvest Festival ~ Oct 17 - Nov 2
        ...
        player:PrintToPlayer("Sorry, I have no wares at this time. We are currently preparing new stock for the next holiday's festivities. ", chatType.SAY, npc:getName());
    end
end;
