...
ITEM_CANNOT_BE_OBTAINED = 6548; -- You cannot obtain the item <item>. Come back after sorting your inventory.
       ...
       KEYITEM_OBTAINED = 6554; -- Obtained key item: <keyitem>.
         NOT_BROKEN_ORB = 7215; -- The Mana Orb in this receptacle is not broken.
    EXAMINED_RECEPTACLE = 7216; -- You have already examined this receptacle.
     DOOR_FIRMLY_CLOSED = 7243; -- The door is firmly closed.
