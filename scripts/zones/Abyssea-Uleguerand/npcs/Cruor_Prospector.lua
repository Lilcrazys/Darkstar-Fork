...
function onEventFinish(player,csid,option)
    ...
    -- Keyitems
    elseif (option == 65539) then -- MAP_OF_ABYSSEA_ULEGUERAND
        if (player:hasKeyItem(MAP_OF_ABYSSEA_ULEGUERAND) == false) then
            player:messageSpecial(KEYITEM_OBTAINED,MAP_OF_ABYSSEA_ULEGUERAND);
            player:addKeyItem(MAP_OF_ABYSSEA_ULEGUERAND);
