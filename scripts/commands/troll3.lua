...
function onTrigger(player)
   ...
   SpawnMob('16974002'); -- Gurlufur The Menacing
   SpawnMob('16974003'); -- Gere
   SpawnMob('16974004'); -- Girzorhor The Imprudent
   ...
   SpawnMob('16974014'); -- Xarhorkur the Claviger
   SpawnMob('16974015'); -- Zurmurwur The ruthless
