...
local atma = {801,802,803,804,805,806,807,808,809,810,811,812,813,814,815,816,817,818,819,820,821,822,823,
 ...
 function onTrigger(player, effect)
	...
	player:addStatusEffectEx(EFFECT_ATMA_OF_THE_MINIKIN_MONSTROSITY,EFFECT_ATMA,1,0,0);
	player:addStatusEffectEx(EFFECT_ATMA_OF_THE_IMPREGNABLE_TOWER,EFFECT_ATMA,1,0,0);
end;