...
function onEffectGain(target, effect)
    ...
    elseif (pwr == 43) then -- ATMA_OF_THE_DEEP_DEVOURER
        ...
        -- target:addMod(MOD_SONG_SPELLCASTING_TIME, -20); shit doesnt exist
...
function onEffectLose(target, effect)
    ...
    elseif (pwr == 43) then -- ATMA_OF_THE_DEEP_DEVOURER
        ...
        -- target:delMod(MOD_SONG_SPELLCASTING_TIME, -20); shit doesnt exist
    elseif (pwr == 44) then -- ATMA_OF_THE_MOUNTED_CHAMPION
