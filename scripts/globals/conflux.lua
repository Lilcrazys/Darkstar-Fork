...
ConfluxData = {16839194, 15, 0, 0x0854, { 50, 100, 150, 200, 250, 300, 350, 400}, 'ConfluxMask[Konschtat]',
...
player:setMaskBit(mask,maskVar,8,true);
    ...
    elseif (npcid == 17658486 or npcid == 17662691 or npcid == 17666711) then
            ...
            return csid, c01 + c02 * 65536, c03 + c04 * 65536, c05 + c06 * 65536, c07 + c08 * 65536, mask, 9, 1, cruor; --[[- 2 ^ bit "this may be causing issues"]]
    else
