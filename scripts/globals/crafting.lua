...
local TI_Cooking = {4355,4416,4489,4381,4413,4558,4546,4440,4561,5930}; -- Sprightly Soup + Way of the Culinarian
local TI_Fishing = {4401,4379,4469,4480,5801,5806,5807,5809,4474,5817}; -- Tiger shark
local TI_Goldsmithing = {12496,12497,12495,13082,13446,13084,12545,13125,16515,11060}; --  Evader Earring**Guild item must be made with an Inferno Crystal
local TI_Leathercraft = {13594,16386,13588,13195,12571,12572,12980,12702,12447,10577}; --  Urja Trousers(Signed with Terra Crystal)
local TI_Smithing = {16530,12299,16512,16650,16651,16559,12427,16577,12428,19788}; -- Gorkhali Kukri
local TI_Woodworking = {22,23,17354,17348,17053,17156,17054,56,17101,18884}; -- Vejovis wand signed
local TI_Synergy = {};
