...
function onMobWeaponSkill(target, mob, skill)
    ...
    elseif (mob:getID() == 16912876) then -- Temp till this is done better and/or AV+Wynavs corrected in DSP
        -- AV's Wynav's
        skillId = 1021; -- Mijin Gakure
    else
        printf("scripts/globals/mobskills/astral_flow_pet_custom.lua couldn't find astral skill for (%d) family", petFamily);
        skillId = 919; -- searing light
    end
