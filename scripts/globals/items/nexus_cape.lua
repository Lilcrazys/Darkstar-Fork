        ...
        if (target:getID() ~= leader:getID()) then
            ...
            local validZoneList =
            {
                -- Custom list of zones allowed:
                  2,  4, 11, 12, 24, 25, 26, 27, 48, 50, 51, 52, 53, 54, 61, 62,
                 65, 68, 79, 80, 81, 82, 83, 84, 87, 88, 89, 90, 91, 94, 95, 96,
                 97, 98,109,120,121,122,125,130,136,137,138,140,141,142,143,145,
                147,149,151,153,154,155,157,158,159,160,161,162,163,164,166,167,
                168,169,171,172,173,174,175,176,177,178,184,190,191,192,193,194,
                195,196,197,198,200,204,205,208,212,213,
