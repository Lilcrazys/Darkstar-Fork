...
function onEffectGain(target,effect)
	...
	target:addMod(MOD_STR, 11);
	target:addMod(MOD_MND, 11);
	target:addMod(MOD_VIT, 11);
	target:addMod(MOD_INT, 11);
	target:addMod(MOD_DEX, 11);
	target:addMod(MOD_AGI, 11);
	target:addMod(MOD_ATT, 10);
	target:addMod(MOD_MATT, 10);
	target:addMod(MOD_MACC, 10);
	target:addMod(MOD_FOOD_ACCP, 10);
	target:addMod(MOD_FOOD_RACCP, 36);
...
function onEffectLose(target,effect)
	...
	target:delMod(MOD_MND, 11);
	target:delMod(MOD_VIT, 11);
	target:delMod(MOD_INT, 11);
	target:delMod(MOD_DEX, 11);
	target:delMod(MOD_AGI, 11);
	target:delMod(MOD_ATT, 10);
	target:delMod(MOD_MATT, 10);
	target:delMod(MOD_MACC, 10);
	target:delMod(MOD_FOOD_ACCP, 10);
	target:delMod(MOD_FOOD_RACCP, 36);
