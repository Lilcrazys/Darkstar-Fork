...
%dumpExe% --lock-tables=false --skip-triggers --skip-extended-insert --order-by-primary --hex-blob --no-create-info --compact --skip-comments -h %mysqlhost% -u %mysqluser% -p%mysqlpass% legiondb char_weapon_skill_points > "E:\database-backup\legiondb\temp\%DATE_DAY%_%DATE_TIME%\char_weapon_skill_points.sql"
