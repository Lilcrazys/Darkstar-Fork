...
//==========================================================//
	...
	// EFFECT_ATMA_OF_THE_STOUT_ARM           = 902,
	// EFFECT_ATMA_OF_THE_TWIN_CLAW           = 903,
	// EFFECT_ATMA_OF_ALLURE                  = 904,
	// EFFECT_ATMA_OF_ETERNITY                = 905,
	// EFFECT_ATMA_OF_THE_HEAVENS             = 906,
	// EFFECT_ATMA_OF_THE_BAYING_MOON         = 907,
	// EFFECT_ATMA_OF_THE_EBON_HOOF           = 908,
	// EFFECT_ATMA_OF_TREMORS                 = 909,
	// EFFECT_ATMA_OF_THE_SAVAGE_TIGER        = 910,
	// EFFECT_ATMA_OF_THE_VORACIOUS_VIOLET    = 911,
	// EFFECT_ATMA_OF_CLOAK_AND_DAGGER        = 912,
	// EFFECT_ATMA_OF_THE_STORMBIRD           = 913,
	// EFFECT_ATMA_OF_THE_NOXIOUS_FANG        = 914,
	// EFFECT_ATMA_OF_VICISSITUDE             = 915,
	// EFFECT_ATMA_OF_THE_BEYOND              = 916,
	// EFFECT_ATMA_OF_STORMBREATH             = 917,
	// EFFECT_ATMA_OF_GALES                   = 918,
	// EFFECT_ATMA_OF_THRASHING_TENDRILS      = 919,
	// EFFECT_ATMA_OF_THE_DRIFTER             = 920,
	// EFFECT_ATMA_OF_THE_STRONGHOLD          = 921,
	// EFFECT_ATMA_OF_THE_HARVESTER           = 922,
	// EFFECT_ATMA_OF_DUNES                   = 923,
	// EFFECT_ATMA_OF_THE_COSMOS              = 924,
	// EFFECT_ATMA_OF_THE_SIREN_SHADOW        = 925,
	// EFFECT_ATMA_OF_THE_IMPALER             = 926,
	// EFFECT_ATMA_OF_THE_ADAMANTINE          = 927,
	// EFFECT_ATMA_OF_CALAMITY                = 928,
	// EFFECT_ATMA_OF_THE_CLAW                = 929,
	// EFFECT_ATMA_OF_BALEFUL_BONES           = 930,
	// EFFECT_ATMA_OF_THE_CLAWED_BUTTERFLY    = 931,
	// EFFECT_ATMA_OF_THE_DESERT_WORM         = 932,
	// EFFECT_ATMA_OF_THE_UNDYING             = 933,
	// EFFECT_ATMA_OF_THE_IMPREGNABLE_TOWER   = 934,
	// EFFECT_ATMA_OF_THE_SMOLDERING_SKY      = 935,
	// EFFECT_ATMA_OF_THE_DEMONIC_SKEWER      = 936,
	// EFFECT_ATMA_OF_THE_GOLDEN_CLAW         = 937,
	// EFFECT_ATMA_OF_THE_GLUTINOUS_OOZE      = 938,
	// EFFECT_ATMA_OF_THE_LIGHTNING_BEAST     = 939,
	// EFFECT_ATMA_OF_THE_NOXIOUS_BLOOM       = 940,
	// EFFECT_ATMA_OF_THE_GNARLED_HORN        = 941,
	// EFFECT_ATMA_OF_THE_STRANGLING_WIND     = 942,
	// EFFECT_ATMA_OF_THE_DEEP_DEVOURER       = 943,
	// EFFECT_ATMA_OF_THE_MOUNTED_CHAMPION    = 944,
	// EFFECT_ATMA_OF_THE_RAZED_RUINS         = 945,
	// EFFECT_ATMA_OF_THE_BLUDGEONING_BRUTE   = 946,
	// EFFECT_ATMA_OF_THE_RAPID_REPTILIAN     = 947,
	// EFFECT_ATMA_OF_THE_WINGED_ENIGMA       = 948,
	// EFFECT_ATMA_OF_THE_CRADLE              = 949,
	// EFFECT_ATMA_OF_THE_UNTOUCHED           = 950,
	// EFFECT_ATMA_OF_THE_SANGUINE_SCYTHE     = 951,
	// EFFECT_ATMA_OF_THE_TUSKED_TERROR       = 952,
	// EFFECT_ATMA_OF_THE_MINIKIN_MONSTROSITY = 953,
	// EFFECT_ATMA_OF_THE_WOULD_BE_KING       = 954,
	// EFFECT_ATMA_OF_THE_BLINDING_HORN       = 955,
	// EFFECT_ATMA_OF_THE_DEMONIC_LASH        = 956,
	// EFFECT_ATMA_OF_APPARITIONS             = 957,
	// EFFECT_ATMA_OF_THE_SHIMMERING_SHELL    = 958,
	// EFFECT_ATMA_OF_THE_MURKY_MIASMA        = 959,
	// EFFECT_ATMA_OF_THE_AVARICIOUS_APE      = 960,
	// EFFECT_ATMA_OF_THE_MERCILESS_MATRIARCH = 961,
	// EFFECT_ATMA_OF_THE_BROTHER_WOLF        = 962,
	// EFFECT_ATMA_OF_THE_EARTH_WYRM          = 963,
	// EFFECT_ATMA_OF_THE_ASCENDING_ONE       = 964,
	// EFFECT_ATMA_OF_THE_SCORPION_QUEEN      = 965,
	// EFFECT_ATMA_OF_A_THOUSAND_NEEDLES      = 966,
	// EFFECT_ATMA_OF_THE_BURNING_EFFIGY      = 967,
	// EFFECT_ATMA_OF_THE_SMITING_BLOW        = 968,
	// EFFECT_ATMA_OF_THE_LONE_WOLF           = 969,
	// EFFECT_ATMA_OF_THE_CRIMSON_SCALE       = 970,
	// EFFECT_ATMA_OF_THE_SCARLET_WING        = 971,
	// EFFECT_ATMA_OF_THE_RAISED_TAIL         = 972,
	// EFFECT_ATMA_OF_THE_SAND_EMPEROR        = 973,
	// EFFECT_ATMA_OF_THE_OMNIPOTENT          = 974,
	// EFFECT_ATMA_OF_THE_WAR_LION            = 975,
	// EFFECT_ATMA_OF_THE_FROZEN_FETTERS      = 976,
	// EFFECT_ATMA_OF_THE_PLAGUEBRINGER       = 977,
	// EFFECT_ATMA_OF_THE_SHRIEKING_ONE       = 978,
	// EFFECT_ATMA_OF_THE_HOLY_MOUNTAIN       = 979,
	// EFFECT_ATMA_OF_THE_LAKE_LURKER         = 980,
	// EFFECT_ATMA_OF_THE_CRUSHING_CUDGEL     = 981,
	// EFFECT_ATMA_OF_PURGATORY               = 982,
	// EFFECT_ATMA_OF_BLIGHTED_BREATH         = 983,
	// EFFECT_ATMA_OF_THE_PERSISTENT_PREDATOR = 984,
	// EFFECT_ATMA_OF_THE_STONE_GOD           = 985,
	// EFFECT_ATMA_OF_THE_SUN_EATER           = 986,
	// EFFECT_ATMA_OF_THE_DESPOT              = 987,
	// EFFECT_ATMA_OF_THE_SOLITARY_ONE        = 988,
	// EFFECT_ATMA_OF_THE_WINGED_GLOOM        = 989,
	// EFFECT_ATMA_OF_THE_SEA_DAUGHTER        = 990,
	// EFFECT_ATMA_OF_THE_HATEFUL_STREAM      = 991,
	// EFFECT_ATMA_OF_THE_FOE_FLAYER          = 992,
	// EFFECT_ATMA_OF_THE_ENDLESS_NIGHTMARE   = 993,
	// EFFECT_ATMA_OF_THE_SUNDERING_SLASH     = 994,
	// EFFECT_ATMA_OF_ENTWINED_SERPENTS       = 995,
	// EFFECT_ATMA_OF_THE_HORNED_BEAST        = 996,
	// EFFECT_ATMA_OF_AQUATIC_ARDOR           = 997,
	// EFFECT_ATMA_OF_THE_FALLEN_ONE          = 998,
	// EFFECT_ATMA_OF_FIRES_AND_FLARES        = 999,
	// EFFECT_ATMA_OF_THE_APOCALYPSE          = 1000,
	// EFFECT_PLACEHOLDER_ONE                 = 1001,
	// EFFECT_PLACEHOLDER_TWO                 = 1002,
	// EFFECT_PLACEHOLDER_ONE                 = 1003,
	// EFFECT_PLACEHOLDER_TWO                 = 1004,
	// EFFECT_PLACEHOLDER_ONE                 = 1005,
	// EFFECT_PLACEHOLDER_TWO                 = 1006,
	// EFFECT_PLACEHOLDER_ONE                 = 1007,
	// EFFECT_PLACEHOLDER_TWO                 = 1008,
	// EFFECT_PLACEHOLDER_ONE                 = 1009,
	// EFFECT_PLACEHOLDER_TWO                 = 1010,
	// EFFECT_PLACEHOLDER_ONE                 = 1011,
	// EFFECT_PLACEHOLDER_TWO                 = 1012,
	// EFFECT_PLACEHOLDER_ONE                 = 1013,
	// EFFECT_PLACEHOLDER_TWO                 = 1014,
	// EFFECT_PLACEHOLDER_ONE                 = 1015,
	// EFFECT_PLACEHOLDER_TWO                 = 1016,
	// EFFECT_PLACEHOLDER_ONE                 = 1017,
	// EFFECT_PLACEHOLDER_TWO                 = 1018,
	// EFFECT_PLACEHOLDER_ONE                 = 1019,
	// EFFECT_PLACEHOLDER_TWO                 = 1020,
	// EFFECT_PLACEHOLDER_ONE                 = 1021,
	// EFFECT_PLACEHOLDER_TWO                 = 1022,
	// EFFECT_PLACEHOLDER_ONE                 = 1023,
