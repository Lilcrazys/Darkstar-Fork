...
-- ---------------------------------------------------------------------------
-- INSERT INTO `abilities` VALUES (abilityId,name,job,level,validTarget,recastTime,recastId,message1,message2,animation,range,isAOE,CE,VE,meritModID,addType,null);
